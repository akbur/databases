...
$(function () {
  clientApp = {
    //FIXME: The current 'addFriend' function just adds the class 'friend'
    ...
    send: function (data) {
      ...
      $.ajax({
        ...
        success: function (res) {
          console.log('chatterbox: Message sent', res);
    ...
    fetch: function (animate) {
      $.ajax({
        ...
        error: function (err) {
          console.error('chatterbox: Failed to fetch messages', err);
        }
      });
    },
